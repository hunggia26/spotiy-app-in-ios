...
final class PlayerControlsView: UIView {
    ...
    private let volumSlider: UISlider = {
        let slider = UISlider()
        slider.value = 0.5
        return slider
    }()
    ...
    override func layoutSubviews() {
        ...
        volumSlider.frame = CGRect(x: 10, y: subtitleLabel.bottom+20, width: width-20, height: 44)
        
        let buttonSize: CGFloat = 60
        playPauseButton.frame = CGRect(x: (width - buttonSize)/2, y: volumSlider.bottom+30, width: buttonSize, height: buttonSize)
